...
class Tmp_field_param
{
  bool m_group:1,
       m_modify_item:1,
       m_table_cant_handle_bit_fields:1,
       m_make_copy_field:1;
public:
...
public:
  ...
  */
  ...
  Item *next;
  int  marker;
  bool null_value;	          /* if item is null - can not be bit-field */
  bool maybe_null:1;                 	/* If item may be null */
  bool in_rollup:1;                    /* If used in GROUP BY list
                                           of a query with ROLLUP */ 
  bool with_param:1;                    /* True if contains an SP parameter */
  bool with_window_func:1;           /* True if item contains a window func */
  /*
...
public:
  ...
  bool alias_name_used:1; /* true if item was resolved against alias */
  /*
